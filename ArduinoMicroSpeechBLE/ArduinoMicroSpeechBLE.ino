...
void setup() {
  ...
  MicroPrintf("Bluetooth® Low Energy Central - LED control");
  ...
  if (peripheral) {
    MicroPrintf("Peripheral Found");
    // discovered a peripheral, print out address, local name, and advertised service
    // MicroPrintf("Found ");
    // MicroPrintf(peripheral.address());
    // MicroPrintf(" '");
    // MicroPrintf(peripheral.localName());
    // MicroPrintf("' ");
    // MicroPrintf(peripheral.advertisedServiceUuid());
    // MicroPrintf("\n");
    ...
    MicroPrintf("Peripheral Not Found. Scanning...");
    BLE.scanForUuid("19B10000-E8F2-537E-4F6C-D104768A1214");
...
void loop() {
  ...
  RespondToCommand(current_time, found_command, score, is_new_command, peripheral);
